...
(function ($) {
  ...
  Hint.prototype = {
    show: function () {
      ...
      if (title && this.enabled) {
        ...
        $tip
          ...
          [this.options.html ? "addClass" : "removeClass"](
            "hint-css-inner-html"
          )
          .css({
    ...
    calculatePosition: function () {
      ...
      $tip.find(".hint-css-arrow")[0].className =
        "hint-css-arrow hint-css-arrow-" + gravity.charAt(0);
    },
    ...
    tip: function () {
      if (!this.$tip) {
        this.$tip = $('<div class="hint-css"></div>').html(
          '<div class="hint-css-arrow"></div><div class="hint-css-inner"></div>'
        );
  ...
  $.hint = function () {
          ...
          hint = new Hint(
            ...
            $.extend({}, $.hint.defaults, options, {
              ...
              title: function () {
                ...
                return $("<div>")
                  .append($.dialog.getKeyAndValTable(keyAndValue, 2))
                  .html();
              },
            })
          );
    ...
    $(document).on("mouseenter touchstart", "[data-hint]", function (e) {
  ...
  $.fn.hint = function (method, params) {
    ...
    switch (method) {
      case "show":
        hint = new Hint(
          $e,
          $.extend({}, $.hint.defaults, {
            gravity: "n",
            className: "hint-object",
            html: true,
            title: function () {
              return $("<div>")
                .append($.dialog.getKeyAndValTable(params, 2))
                .html();
            },
          })
        );
      ...
      case "update":
        hint.update(
          $("<div>").append($.dialog.getKeyAndValTable(params, 2)).html()
        );
        break;
      case "hide":
        hint.hoverState = "out";
  ...
  $.hint.defaults = {
    ...
    opacity: 0.8,
    title: "title",
    textAlign: "center", //data-hint-align="left"
