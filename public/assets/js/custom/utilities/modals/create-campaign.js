...
var KTCreateCampaign = (function () {
    ...
    var initForm = function () {
        ...
        var valueMin = document.querySelector(
            "#kt_modal_create_campaign_age_min"
        );
        var valueMax = document.querySelector(
        ...
        // Init tagify
        var tagifyElement = document.querySelector(
        ...
        var tagify = new Tagify(tagifyElement, {
            ...
            templates: {
                tag: function (tagData) {
                    const countryPath =
                        tagifyElement.getAttribute("data-kt-flags-path") +
                        tagData.value.toLowerCase().replace(/\s+/g, "-") +
                        ".svg";
                    try {
                        // _ESCAPE_START_
                        return `<tag title='${
        ...
        var myDropzone = new Dropzone(
            "#kt_modal_create_campaign_files_upload",
            {
        ...
        const allDuration = document.querySelector(
            "#kt_modal_create_campaign_duration_all"
        );
        const fixedDuration = document.querySelector(
        ...
        // Init budget slider
        var budgetSlider = document.querySelector(
