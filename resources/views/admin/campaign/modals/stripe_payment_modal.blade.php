                ...
                <form action="{{ route('admin.updatePaymentMethodForm') }}" method="post"  class="updatePaymentMethodForm">
                    <div class="card-body pt-">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                <label class="d-flex align-items-center form-label">
                                    <span class="">Product ID (for recurring payments)</span>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" data-modal="#stripe_modal" class="btn updatePaymentModal btn-lg btn-primary" data-kt-element="type-next">
