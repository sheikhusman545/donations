    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.updateGallery') }}" id="UpdateGalleryForm" enctype="multipart/form-data" method="POST">
                    <div class="card-body pt-">
                        <div class="w-100">
                            <div class="fv-row mb-10">
                                ...
                                <input name="title" id="EditGalleryTitle" class="form-control form-control-lg form-control-solid" value="" />
                            </div>
                            <div class="fv-row mb-10">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <textarea class="form-control form-control-lg form-control-solid" name="embed" id="EditGalleryEmbed" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="button" id="UpdateGallery" class="btn btn-lg btn-primary" data-kt-element="type-next">
