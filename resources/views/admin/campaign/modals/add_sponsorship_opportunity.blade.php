    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storeSponsorShipOpportunities') }}" id="addSponsorShipOpportunitiesForm" enctype="multipart/form-data" method="POST">
                    <div class="card-body pt-">
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-lg form-control-solid" name="amount" value="{{ old('amount') }}" type="number">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addSponsorShipOpportunities" class="btn btn-lg btn-primary" data-kt-element="type-next">
...
<div class="modal fade" id="add_our_sponsorship" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            <div class="modal-header py-7 d-flex justify-content-between">
                <h2>
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storeOurSponsors') }}" id="addOurSponsorForm" enctype="multipart/form-data" method="POST">
                    <div class="card-body pt-">
                        <div class="w-100">
                            <div class="fv-row mb-10">
                                <input type="hidden" name="campaign_id"  value="{{ $campaign->id }}">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addOurSponsor" class="btn btn-lg btn-primary" data-kt-element="type-next">
                            <span class="indicator-label">Submit</span>
                            <span class="indicator-progress">Please wait...
                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                        </button>
...
<script>
    $(document).ready(function() {
        ...
        $('#addOurSponsor').click(function() {
            let formData = new FormData($('#addOurSponsorForm')[0]);
            formData.append('_token', '{{ csrf_token() }}'); // Add CSRF token if required

            let action = $('#addOurSponsorForm').attr('action');
            console.log(action);
            ajaxCall(
                action
                , 'POST'
