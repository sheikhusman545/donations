...
{{-- OJC FUND MODAL --}}
<div class="modal fade" id="ojc_fund_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            <div class="modal-header py-7 d-flex justify-content-between">
                <h2>Ojc Fund Configurations</h2>
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.updatePaymentMethodForm') }}" method="post"  class="updatePaymentMethodForm">
                    <div class="card-body pt-">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input type="hidden" value="ojc_fund" name="payment_method">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" data-modal="#ojc_fund_modal" class="btn updatePaymentModal btn-lg btn-primary" data-kt-element="type-next">
