    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storeGifts') }}" id="addGiftForm" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="card-body pt-">
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="draw_date" type="datetime-local" class="form-control form-control-lg form-control-solid" />
                            </div>
                            <div class="fv-row mb-10">
                                <label class="form-label">Details</label>
                               <textarea name="details" class="form-control form-control-lg form-control-solid" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addGift"  class="btn btn-lg btn-primary" data-kt-element="type-next">
