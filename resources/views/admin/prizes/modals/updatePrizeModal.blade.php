    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.editPrize') }}" id="EditPrizeForm" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="card-body pt-">
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="name" id="name" class="form-control form-control-lg form-control-solid" value="" />
                                @if ($errors->has('name'))
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="draw_date" id="draw_date" type="datetime-local" class="form-control form-control-lg form-control-solid" />
                            </div>
                            <div class="fv-row mb-10">
                                <label class="d-block fw-semibold fs-6 mb-5">
                                    <span class="required"> Image</span>
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Prize Image"></i>
                                </label>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="EditPrize" class="btn btn-lg btn-primary" data-kt-element="type-next">
