    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storePrizes') }}" id="addPrizeForm" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
                                    <div class="image-input-wrapper w-125px h-125px" @if(isset($prize->image))
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addPrize" class="btn btn-lg btn-primary" data-kt-element="type-next">
