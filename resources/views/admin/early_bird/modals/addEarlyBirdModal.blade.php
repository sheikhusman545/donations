    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storeEarlyBird') }}" id="addEarlyBirdForm" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="card-body pt-">
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="start_date" type="datetime-local" class="form-control form-control-lg form-control-solid" value="" />
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addEarlyBird" class="btn btn-lg btn-primary" data-kt-element="type-next">
