    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.UpdateEarlyBird') }}" id="UpdateEarlyBirdForm" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="card-body pt-">
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="start_date" id="start_date" required type="datetime-local" class="form-control form-control-lg form-control-solid" value="" />
                            </div>

                            <div class="fv-row mb-10">
                                <label class="form-label required">End Date</label>
                                <input name="end_date" id="end_date" required type="datetime-local" class="form-control form-control-lg form-control-solid" />
                            </div>
                            <div class="fv-row mb-10">
                                ...
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
                                    <div class="image-input-wrapper w-125px h-125px"
                                       id="EditEarlyBirdBgImage" style="background-image: url('');">
                                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="UpdateEarlyBird" class="btn btn-lg btn-primary" data-kt-element="type-next">
